...
for num in range(100):
    find = True
    posts_path = '//*[@class="bdao358l om3e55n1 g4tp4svg aeinzg81 i15ihif8 th51lws0 h07fizzr mfn553m3 jbg88c62 s9djjbeh t1fg2s7t sjylff4p poaa5t79"]/div[2]/div[2]/div['+str(num+1)+']'
    posts = browser.find_elements_by_xpath(posts_path)
    sql_post = "insert into fbfriends.posts values(0,\'{}\','null')".format(num + 1)
    cursor.execute(sql_post)
    cursor.connection.commit()
    like_class = '//*[@class="bdao358l om3e55n1 g4tp4svg aeinzg81 i15ihif8 th51lws0 h07fizzr mfn553m3 jbg88c62 s9djjbeh t1fg2s7t sjylff4p poaa5t79"]/div[2]/div[2]/div[' + str(
        num + 1) + ']//*[@class="i85zmo3j alzwoclg cgu29s5g lq84ybu9 hf30pyar"]/div'
